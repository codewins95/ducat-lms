...
export const createCourseByFaculty = async (req, res) => {
    ...
    const { courseTitle, courseSlug, courseContent, courseFee, courseAuthor } = req.body;
    ...
    try {
        if (courseTitle && courseContent && facultyId && courseAuthor) {
